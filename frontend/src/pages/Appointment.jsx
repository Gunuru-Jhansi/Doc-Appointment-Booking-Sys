...
const Appointment = () => {
  ...
  const bookAppointment = async()=>{
    ...
    try {
      ...
      const {data}=await axios.post(backendUrl+'/api/user/book-appointment',{docId,slotDate,slotTime,docDate},{headers:{token}})
  ...
  return docInfo && (
    ...
    {/* ---------------bOOKING sLOTS----------- */}
    <div className='sm:ml-80 sm:plt-4 mt-4 font-medium text-gray-700'>
      <p>Booking Slots</p>
